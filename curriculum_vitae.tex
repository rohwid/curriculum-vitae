...
\cvitem{Description}{Created program to generate the RPG player character or enemy gameplay attributes based on \textit{k}-NN and Naive Bayes algorithm then the result was classified with Neural Network Multi-class Classification. This project was created using Python and it's libraries.}
...
%\cvline{\textbf{Nagios}}{Deploy Nagios monitoring tools to monitor hardware and services in many servers.}
